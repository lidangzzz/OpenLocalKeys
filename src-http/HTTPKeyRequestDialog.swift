...
struct HTTPKeyRequestDialog: View {
        ...
        VStack(spacing: 0) {
            ...
            HStack {
                ...
                VStack(alignment: .leading, spacing: 4) {
                    Text("HTTP Key Access Request")
                        .font(.headline)
                    Text("\(clientOrigin) wants to access your API keys")
                        .font(.caption)
...
struct HTTPKeyRequestItemRow: View {
    let item: ApiKeyItem
    let isSelected: Bool
